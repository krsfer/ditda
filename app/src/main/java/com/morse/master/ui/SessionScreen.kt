...
private fun CircularProgressBar(
    ...
    val resolvedProgress = if (progressColor == Color.Unspecified) {
...
fun SessionScreen(
    ...
    Column(
        ...
        Column(
            ...
            val trainingSetProgressState = trainingSetProgressBarState(
                playbackMode = playbackMode,
                currentIteration = currentIteration,
                repeatCount = settings.trainingSetRepeatCount
            )
            CircularProgressBar(
                progress = trainingSetProgressState.progress,
                label = "${trainingSetProgressState.percentage}%"
            )
            Button(
